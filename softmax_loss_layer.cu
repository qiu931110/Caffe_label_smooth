...
__global__ void SoftmaxLossForwardGPU(const int nthreads,
          ...
          Dtype* counts,const bool has_label_smooth_,const float label_smooth_,const int num_class) {
...
__global__ void SoftmaxLossBackwardGPU(const int nthreads, const Dtype* top,
          ...
          const int ignore_label_, Dtype* counts,const bool has_label_smooth_,const float label_smooth_,const int num_class) {
